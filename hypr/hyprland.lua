...
hl.bind("SUPER + G", hl.dsp.exec_cmd("qs ipc call wallpaper toggle"),
...
-- to find the class you need to type "hyprctl clients | grep (client name)" then copy the class name into the thing
hl.window_rule({
	name = "spotify-on-ws2",
	match = { class = "^(Spotify)$" },
	workspace = "2 silent",
...
hl.window_rule({
	name = "duckstation-on-ws4",
	match = { class = "^(org.duckstation.DuckStation)$" },
	workspace = "4",
})
hl.window_rule({
	name = "lutris-on-ws4",
